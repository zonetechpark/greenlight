...
class UserMailerPreview < ActionMailer::Preview
  def initialize(_params)
    @logo = "https://zonetechpark.co/wp-content/uploads/2020/03/ztp-logo-white-3.png"
    @color = "#467fcf"
  end
  ...
  def user_promoted
    ...
    logo_image = "https://zonetechpark.co/wp-content/uploads/2020/03/ztp-logo-white-3.png"
    user_color = "#467fcf"
